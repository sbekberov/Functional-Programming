...
trait EncoderInstances {
  ...
  implicit val boolEncoder: Encoder[Boolean] =  // TODO Define an implicit value of type `Encoder[Boolean]`
...
trait AuthorCodecs {
  implicit val authorEncoder: Encoder[Author] =
    ObjectEncoder.field[String]("name")
      .zip(ObjectEncoder.field[String]("surname"))
  ...
  implicit val authorDecoder: Decoder[Author] =
    Decoder.field[String]("name")
      ...
      .transform[Author](author => Author(author._1, author._2))
}
